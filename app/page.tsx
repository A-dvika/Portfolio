    ...
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          I’m Advika Thakur, a passionate AI and ML enthusiast with a knack for solving complex problems through innovative solutions. With a strong foundation in AI, machine learning, and web development,
           I’ve led and contributed to projects that push the boundaries of technology.
          </p>
